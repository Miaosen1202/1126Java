...
/**
 * 功能：实现电子学档页面集删除、移动、复制后，序号重新计算功能
 *
 * @author 黄建林
 */
@Service
public class EPortfolioColumnSeqMoveService extends SeqMoveServiceAbstract<UserEPortfolioColumn>{
     ...
     * @param seq 移动到的位置
     */
    public List<UserEPortfolioColumn> seqChange(int operate, List<UserEPortfolioColumn> items , int type, Long moveId, Integer seq) {
        ...
        items = BeanUtil.beanCopyPropertiesForList(moveItems, UserEPortfolioColumn.class);
