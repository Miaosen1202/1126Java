...
@ResourceInfo(name = Constants.RESOURCE_TYPE_QUIZ_TEST_QUESTION_RECORD, description = "测验问题记录")
public class QuizTestQuestionRecordQuery implements IDataQueryComponent<QuizQuestionRecord> {
    @Autowired
    ...
    /**
     * @api {get} /quizQuestionTestRecord/list 学生答题测验问题选项记录列表
     * @apiDescription 依据quizRecordId查询对应的所有测验问题选项记录信息
     * @apiName quizQuestionTestRecordList
     * @apiGroup Quiz
     * @apiParam String quizRecordId quizRecordID
     * @apiExample {json} 请求示例:
     * http://localhost:8080/quizQuestionTestRecord/list?quizRecordId=16
